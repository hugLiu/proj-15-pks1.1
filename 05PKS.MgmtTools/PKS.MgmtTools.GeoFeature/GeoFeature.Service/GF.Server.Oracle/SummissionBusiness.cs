...
namespace GF.Server.Oracle
{
    public class SummissionBusiness : ISubmission
    {
        ...
        private GeoFeature GetBoListByName(string name, string ft)
        {
            ...
            return DBUtility.OracleDBHelper.OracleHelper.ExecuteQueryText<GeoFeature>(strSql.ToString(), parameters).FirstOrDefault();
        }
        ...
        private bool GeometryeExist(Geometry geometry)
        {
            ...
            List<Geometry> GeometryList = DBUtility.OracleDBHelper.OracleHelper.ExecuteQueryText<Geometry>(strSql.ToString(), parameters);
        ...
        private bool PropertyExist(Property property)
        {
            ...
            List<Property> propertyList = DBUtility.OracleDBHelper.OracleHelper.ExecuteQueryText<Property>(strSql.ToString(), parameters);
