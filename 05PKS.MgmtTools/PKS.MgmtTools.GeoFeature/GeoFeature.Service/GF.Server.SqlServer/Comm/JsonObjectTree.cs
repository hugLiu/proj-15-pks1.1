        ...
        public string GetSQL(ObjModel node, string bot)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        strSQL = " PROPERTY.md.exist('/PropertySet[@name=" + strArr[0] + "]/P[@n=" + strArr[1] + "][text()" + node.Opt + "xs:date(" + node.Value + ")]' passing t2.md )=1 ";
                    }
                    if (datatype.ToUpper() == PropertyDataType.Decimal.ToString().ToUpper())
                    {
                        strSQL = " PROPERTY.md.exist('/PropertySet[@name=" + '"' + strArr[0] + '"' + "]/P[@n=" + '"' + strArr[1] + '"' + "][text()" + node.Opt + node.Value + "]')=1 ";
                    }
