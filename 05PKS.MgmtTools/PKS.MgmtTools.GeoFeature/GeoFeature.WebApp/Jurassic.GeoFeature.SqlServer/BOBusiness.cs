    ...
    public class BOBusiness : IBO
    {
        ...
        public int Insert(BOModel model)
        {
            ...
            SqlParameter[] parameters = {
                                ...
                                new SqlParameter("@BOTID", SqlDbType.VarChar,50),                             
            ...
            return DBUtility.SqlServerDBHelper.ExecuteSql(strAddSql.ToString(), parameters);
        }
        ...
        public int Delete(BOModel model)
        {
            ...
            bool Rtn = DBUtility.SqlServerDBHelper.ExecuteSql(ExecSql);
            if (Rtn == true)
                return 1;
            else
                return 0;
        ...
        public IList<BOModel> GetListByID(string ID)
        {
            ...
            strSql.Append(" SELECT  boid,name,botid,case  isuse when 1 then '是' when 0 then '否' end as isuse FROM BO");
            strSql.Append(" WHERE BOID =@BOID ");
            SqlParameter[] parameters = {
                                new SqlParameter("@BOID", SqlDbType.VarChar,36)
                                                };
            parameters[0].Value = ID;
            return DBUtility.SqlServerDBHelper.ExecuteQueryText<BOModel>(strSql.ToString(), parameters);
        }
        ...
        public IList<BOModel> GetList()
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" SELECT  boid,name,botid,case  isuse when 1 then '是' when 0 then '否' end as isuse FROM BO");
            return DBUtility.SqlServerDBHelper.ExecuteQueryText<BOModel>(strSql.ToString());
        }
        ...
        public DataTable GetBoListByID(string BOID)
        {
            ...
            return DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString(), parameters).Tables[0];
        }
        ...
        public List<BOModel> GetBoListByBOTID(string botID)
        {
            ...
            strSql.Append(" SELECT  boid,BO.name,BO.botid,case  isuse when 1 then '是' when 0 then '否' end as isuse,objecttype.BOT FROM BO");
            ...
            if (botID != "")
            {
                ...
                ds = DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString(), parameters);
            }
            else
            {
                strSql.Append("  order by  BO.botid");
                ds = DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString());
            }
            if (ds != null)
            {
        ...
        public List<BOModel> GetNearBOByID(string boid, double distance, string bot = null, string boc = null)
        {
            ...
            oraParams.Add(new SqlParameter("@BOID", SqlDbType.VarChar) { Value = boid });
            oraParams.Add(new SqlParameter("@DISTANCE", SqlDbType.VarChar) { Value = distance });
            oraParams.Add(new SqlParameter("@BOTID", SqlDbType.VarChar) { Value = bot });
            oraParams.Add(new SqlParameter("@BOC", SqlDbType.VarChar) { Value = boc });


            return DBUtility.SqlServerDBHelper.ExecuteQueryText<BOModel>(strSql.ToString(), oraParams.ToArray());
        }
        ...
        public DataSet GetNearBOByLocation(string wkt, double distance, string bot = null, string boc = null)
        {
            ...
            SqlParameter[] parameters = {
                                new SqlParameter("@WKT", SqlDbType.VarChar,50),
                                new SqlParameter("@DISTANCE", SqlDbType.VarChar,50),
                                new SqlParameter("@BOTID", SqlDbType.VarChar,50),
                                new SqlParameter("@BOC", SqlDbType.VarChar,50)
                                                };
            ...
            return DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString(), parameters);
        }
        ...
        public DataSet GetNearBOByName(string name, string bot0, double distance, string bot = null, string boc = null)
        {
            ...
            var oraParams = new List<SqlParameter>();
            oraParams.Add(new SqlParameter("@NAME", SqlDbType.VarChar) { Value = name });
            oraParams.Add(new SqlParameter("@BOTID", SqlDbType.VarChar) { Value = bot0 });
            oraParams.Add(new SqlParameter("@DISTANCE", SqlDbType.VarChar) { Value = distance });
            oraParams.Add(new SqlParameter("@BOTID", SqlDbType.VarChar) { Value = bot });
            oraParams.Add(new SqlParameter("@BOC", SqlDbType.VarChar) { Value = boc });

            return DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString(), oraParams.ToArray());
        }
        ...
        public IList<BoExModel> GetBoExByBotID(string botID)
        {
            ...
            List<BOModel> list = DBUtility.SqlServerDBHelper.ExecuteQueryText<BOModel>(strSql.ToString(), parameters);
        ...
        public List<BOModel> GetRelatedBO(string boid, string relation, string direction, string bot = null, string boc = null)
        {
            ...
            var oraParams = new List<SqlParameter>();
            oraParams.Add(new SqlParameter("@RT", SqlDbType.VarChar, 36) { Value = relation });
            oraParams.Add(new SqlParameter("@BOID", SqlDbType.VarChar, 36) { Value = boid });
            if (bot != null) oraParams.Add(new SqlParameter("@BOT", SqlDbType.VarChar, 36) { Value = bot });
            if (boc != null) oraParams.Add(new SqlParameter("@BOC", SqlDbType.VarChar, 36) { Value = boc });
            return DBUtility.SqlServerDBHelper.ExecuteQueryText<BOModel>(strSql.ToString(), oraParams.ToArray());
        }
        ...
        public List<BOModel> GetBOByNameAndRelation(string name, string bot0, string relation, string direction, string bot = null, string boc = null)
        {
            ...
            var oraParams = new List<SqlParameter>();
            oraParams.Add(new SqlParameter("@NAME", SqlDbType.VarChar, 36) { Value = name });
            oraParams.Add(new SqlParameter("@BOT0", SqlDbType.VarChar, 36) { Value = bot0 });
            oraParams.Add(new SqlParameter("@RT", SqlDbType.VarChar, 36) { Value = relation });
            if (bot != null) oraParams.Add(new SqlParameter("@BOT", SqlDbType.VarChar, 36) { Value = bot });
            if (boc != null) oraParams.Add(new SqlParameter("@BOC", SqlDbType.VarChar, 36) { Value = boc });
        ...
        public int Upload3GX(List<BoExModel> boExModelList, string replaceOrLeave = null)
        {
            ...
            foreach (BoExModel bo in boExModelList)
            {
                ...
                #region 添加对象
                SqlCommand oracleComm = new SqlCommand();
                StringBuilder strSql = new StringBuilder();
                //存在且保留
                ...
                else
                {
                    ...
                    SqlParameter[] parameters = {
                                new SqlParameter("@BOPID", SqlDbType.VarChar,36),
                                new SqlParameter("@NAME", SqlDbType.VarChar,50),
                                new SqlParameter("@BOTID", SqlDbType.VarChar,50),
                                new SqlParameter("@BOC", SqlDbType.VarChar,50),
                                new SqlParameter("@SOURCEDB", SqlDbType.VarChar,150),
                                new SqlParameter("@GATHERUSER", SqlDbType.VarChar,50),
                                new SqlParameter("@GATHERDATE", SqlDbType.Date),
                                new SqlParameter("@ISUSE", SqlDbType.Char,1),
                                new SqlParameter("@BOID", SqlDbType.VarChar,36)
                                               };
                ...
                else
                {
                    ...
                    if (isGeometryExist)
                    {
                        SqlCommand oracleCommDele = new SqlCommand();
                    ...
                    {
                        SqlCommand oracleComm1 = new SqlCommand();
                ...
                foreach (AliasNameModel aliasName in bo.AliasNameList)
                {
                    ...
                    else
                    {
                        ...
                        if (!isAliasNameExist)
                        {
                            ...
                            strSql1.Append(" NAME,CREATUSER,UPLOADDATE,BOID,APPDOMAIN)");
                            strSql1.Append(" VALUES (@NAME,@CREATUSER,@UPLOADDATE,@BOID,@APPDOMAIN)");
                        }
                        ...
                        SqlParameter[] parameters1 = {
                                new SqlParameter("@NAME", SqlDbType.VarChar,50),
                                new SqlParameter("@CREATUSER", SqlDbType.VarChar,50),
                                new SqlParameter("@UPLOADDATE", SqlDbType.Date),
                                new SqlParameter("@BOID", SqlDbType.VarChar,36),
                                new SqlParameter("@APPDOMAIN", SqlDbType.VarChar,50)
                                               };
                        parameters1[0].Value = aliasName.Name;
                        parameters1[1].Value = aliasName.CreatUser;
                        parameters1[2].Value = aliasName.UploadDate;
                        parameters1[3].Value = aliasName.BOId;
                        parameters1[4].Value = aliasName.AppDomain;
                        SqlCommand oracleComm1 = new SqlCommand();
                        oracleComm1.CommandText = strSql1.ToString();
                        for (int j = 0; j < parameters1.Length; j++)
                            oracleComm1.Parameters.Add(parameters1[j]);
                ...
                i = i + (DBUtility.SqlServerDBHelper.ExecuteCommand(oracleCommList) == true ? 1 : 0);
            }
            return i;
        }
        ...
        public bool Upload3GXTran(List<BoExModel> boExModelList, string replaceOrLeave = null)
        {
            ...
            return DBUtility.SqlServerDBHelper.ExecuteCommand(oracleCommList);
        }
        ...
        public List<string> GetBoc(List<string> botList)
        {
            ...
            DataSet bocStr = DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString(), oraParams.ToArray());
        ...
        public List<BOModel> GetBoByFilter(List<string> filterList, Dictionary<string, object> parameter, string botid = null, string ns = null)
        {
            ...
            {
                oraParams.Add(new SqlParameter(kvp.Key, SqlDbType.VarChar) { Value = kvp.Value });
            }
            if (botid != null)
            {
                strSql.Append(" AND BO.BOTID=@BOTID ");
                oraParams.Add(new SqlParameter("@BOTID", SqlDbType.VarChar) { Value = botid });
            }
            if (ns != null)
            {
                strSql.Append(" AND PROPERTY.NS=@NS");
                oraParams.Add(new SqlParameter("@NS", SqlDbType.VarChar) { Value = ns });
            }
            return DBUtility.SqlServerDBHelper.ExecuteQueryText<BOModel>(strSql.ToString(), oraParams.ToArray());
        }
        ...
        public string GetPropertyType(string boid, string propertyName)
        {
            ...
            var oraParams = new List<SqlParameter>();
            oraParams.Add(new SqlParameter("@BOID", SqlDbType.VarChar) { Value = boid });
            oraParams.Add(new SqlParameter("@PROPERTYNAME", SqlDbType.VarChar) { Value = propertyName });
            DataSet ds = DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString(), oraParams.ToArray());
        ...
        public DataSet GetDictionary(bool isWithAlias)
        {
            ...
            return DBUtility.SqlServerDBHelper.ExecuteQueryText(strSql.ToString());
        }
        ...
        public DataTable GetALIASNAME(string BOID)
        {
            ...
            try
            {
                dt = DBUtility.SqlServerDBHelper.ExecuteQueryText(Sql).Tables[0];
            }
            catch
            {
        ...
        public List<BOModel> GetBoByBoNameAndBot(string boName, string botName)
        {
            ...
            SqlParameter[] parameters = {
                                ...
                                new SqlParameter("@BONAME", SqlDbType.VarChar,36)
               };
        ...
        public bool UploadBoPropertyTran(List<BoExModel> boExModelList)
        {
            ...
            foreach (BoExModel bo in boExModelList)
            {
                ...
                else
                {
                    ...
                    var oraParams = new List<SqlParameter>();
                    oraParams.Add(new SqlParameter("@BOID", SqlDbType.VarChar) { Value = bo.Boid });
                    oraParams.Add(new SqlParameter("@NAME", SqlDbType.VarChar) { Value = bo.Name });
                    oraParams.Add(new SqlParameter("@BOTID", SqlDbType.VarChar) { Value = bo.Botid });
                    oraParams.Add(new SqlParameter("@ISUSE", SqlDbType.Char) { Value = bo.Isuse });
                ...
                foreach (PropertyModel property in bo.PropertyList)
                {
                    ...
                    if (isPropertyExist)
                    {
                        ...
                        var oraParams = new List<SqlParameter>();
                        oraParams.Add(new SqlParameter("@BOID", SqlDbType.VarChar) { Value = property.BOId });
                        oraParams.Add(new SqlParameter("@NS", SqlDbType.VarChar) { Value = property.NS });
                        SqlCommand oracleComm = new SqlCommand();
                    ...
                    var oraParams1 = new List<SqlParameter>();
                    oraParams1.Add(new SqlParameter("@BOID", SqlDbType.VarChar) { Value = property.BOId });
                    oraParams1.Add(new SqlParameter("@NS", SqlDbType.VarChar) { Value = property.NS });
                    oraParams1.Add(new SqlParameter("@MD", SqlDbType.Xml) { Value = property.MD });
                    oraParams1.Add(new SqlParameter("@MDSOURCE", SqlDbType.VarChar) { Value = property.MdSource });
        ...
        public bool InsertBOandPara(List<string> SqlList)
        {
            ...
            try
            {
                BRtn = DBUtility.SqlServerDBHelper.ExecuteSql(Sql);
            }
            catch
            {
                BRtn = false;
