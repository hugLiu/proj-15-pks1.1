...
namespace PKS.SZZSK.IService.Common
{
    public interface IViewService
    {
        ...
        int GetCountByQuery(string grid, object[] queryParams);
        ...
        long GetBOCountByName(string bot, string bo);
        long GetBOCountByProperties(string bot, Dictionary<string, List<string>> properties);
        string ReplaceParameters(string grid, params object[] parameters);
    }
}
