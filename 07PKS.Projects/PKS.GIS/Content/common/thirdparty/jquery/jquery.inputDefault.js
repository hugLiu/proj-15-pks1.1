...
(function($){
	$.fn.inputDefault = function(options){
		var defaults = {attrName: 'blankText', size:0, bold: false, italic:false, color:'#868686'};
		...
		this.each(function(){
			...
			var plusTop = (outerHeight - innerHeight)/2+3;
			...
			var lable = $("<label style='text-align:left;'></label>").text(text).css(css).click(function(){
				$(this).hide();
				$(this).prev().focus();
			});
