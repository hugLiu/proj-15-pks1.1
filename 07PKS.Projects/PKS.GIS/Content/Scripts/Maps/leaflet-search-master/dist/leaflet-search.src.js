...
L.Control.Search = L.Control.extend({
	...
	onAdd: function (map) {
		...
		//this.setLayer( this._layer );    //pengjian add
  ...
  _searchInLayer: function(layer, retRecords, propName) {
    ...
    if(layer instanceof L.Marker || layer instanceof L.CircleMarker)
    {
      ...
      else if (_getPath(layer.feature, propName)) {
          loc = layer.getLatLng();
          loc.layer = layer;
          retRecords[_getPath(layer.feature, propName)] = loc;
      }
      else {
    ...
    else if(layer instanceof L.LayerGroup)
    {
      layer.eachLayer(function (layer) {
        ...
        for(var i=0;i<layer.length;i++){
            that._searchInLayer(layer[i], retRecords, propName);
        };
    }
  },
	...
	_recordsFromLayer: function() {	//return table: key,value from layer
	    ...
	    //pengjian add----------------------------------
		if (Object.prototype.toString.call(this._layer) == '[object Array]') {
		    for(var i=0;i<this._layer.length;i++){
		        that._searchInLayer(this._layer[i], retRecords, propName);
		    };
		}
		else {
		    //pengjian---------------------------------------
		...
		else
		{
			...
			else
			{
				...
				else
				{
				    ...
				    loc.layer.openPopup();   //pengjian add
