...
L.Draw.Polyline = L.Draw.Feature.extend({
    ...
    // zhanglingling change at 20170310 to get rid of the English tooltips
	_getTooltipText: function () {
		...
		if (this._markers.length === 0) {
			labelText = {
				text: '0m'//L.drawLocal.draw.handlers.polyline.tooltip.start //"¿ªÊ¼»­Ïß"
			};
		} else {
...
L.Tooltip = L.Class.extend({
	...
	updateContent: function (labelText) {
        ...
        //zhanglingling change at 20170310 to get rid of the English tooltip
		this._container.innerHTML =
            (labelText.subtext.length > 0 ? '<span class="leaflet-draw-tooltip-subtext">' + labelText.subtext + '</span>' + '<br />' : '0m');
