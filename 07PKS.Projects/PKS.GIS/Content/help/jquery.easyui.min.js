 ...
 */
(function($){
$.parser={auto:true,onComplete:function(_1){//杨恒涛 修改 将draggable 修改为draggables 以解决easyui和jquery.layout之间的冲突，以下代码中的所有draggable都替换成draggables
},plugins:["draggables","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","datalist","tabs","accordion","window","dialog","form"],parse:function(_2){
var aa=[];
...
_29(e,"mousedown");
if($.fn.draggables.isDragging||$.fn.resizable.isResizing){
e.preventDefault();
}
};
function _2a(e){
...
(function($){
function _2f(e){
var _30=$.data(e.data.target,"draggables");
var _31=_30.options;
var _32=_30.proxy;
var _33=e.data;
...
function _35(e){
var _36=$.data(e.data.target,"draggables");
var _37=_36.options;
var _38=_36.proxy;
if(!_38){
_38=$(e.data.target);
...
function _39(e){
if(!$.fn.draggables.isDragging){
return false;
}
var _3a=$.data(e.data.target,"draggables");
var _3b=_3a.options;
...
var _40=$.data(e.data.target,"draggables");
_2f(e);
...
_3f(e);
var _45=$.data(e.data.target,"draggables");
var _46=_45.proxy;
var _47=_45.options;
if(_47.revert){
if(_48()==true){
...
function _44(){
if($.fn.draggables.timer){
clearTimeout($.fn.draggables.timer);
$.fn.draggables.timer=undefined;
}
$(document).unbind(".draggables");
$.fn.draggables.isDragging=false;
setTimeout(function(){
$("body").css("cursor","");
},100);
};
$.fn.draggables=function(_4d,_4e){
if(typeof _4d=="string"){
return $.fn.draggables.methods[_4d](this,_4e);
}
return this.each(function(){
var _4f;
var _50=$.data(this,"draggables");
if(_50){
_50.handle.unbind(".draggables");
_4f=$.extend(_50.options,_4d);
}else{
_4f=$.extend({},$.fn.draggables.defaults,$.fn.draggables.parseOptions(this),_4d||{});
}
var _51=_4f.handle?(typeof _4f.handle=="string"?$(_4f.handle,this):_4f.handle):$(this);
$.data(this,"draggables",{options:_4f,handle:_51});
if(_4f.disabled){
$(this).css("cursor","");
return;
}
_51.unbind(".draggables").bind("mousemove.draggables",{target:this},function(e){
if($.fn.draggables.isDragging){
return;
}
var _52=$.data(e.data.target,"draggables").options;
if(_53(e)){
...
$.extend(e.data,_56);
var _57=$.data(e.data.target,"draggables").options;
if(_57.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.draggables",e.data,_39);
$(document).bind("mousemove.draggables",e.data,_3f);
$(document).bind("mouseup.draggables",e.data,_43);
$.fn.draggables.timer=setTimeout(function(){
$.fn.draggables.isDragging=true;
_39(e);
},_57.delay);
return false;
});
function _53(e){
var _58=$.data(e.data.target,"draggables");
var _59=_58.handle;
var _5a=$(_59).offset();
...
$.fn.draggables.parseOptions=function(_5d){
var t=$(_5d);
...
$.fn.draggables.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,delay:100,onBeforeDrag:function(e){
...
_e7.disabledNodes=[];
_e8.dnd=true;
_e9.find("div.tree-node").draggables({disabled:false,revert:true,cursor:"pointer",proxy:function(_ea){
...
var _fe=$(_fc).draggables("proxy").find("span.tree-dnd-icon");
...
pos=_1f4("bottom");
/**
 * 雷凯 解决：提示框在默认的的况下，因提示信息的字数和页面大小的限制，是提示框无法正常显示
 */
if(pos.top>($(window)._outerHeight()+$(document).scrollTop())){
	pos=_1f4("right");
}
}else{
...
if(opts.modal==true){
_27f.mask=$("<div class=\"window-mask\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;\" frameborder=\"0\"></iframe></div>").insertAfter(_27f.window);//杨恒涛，插入iframe，解决系统提示窗被activieX控件遮挡问题
...
_286.window.draggables({handle:">div.panel-header>div.panel-title",disabled:_286.options.draggables==false,onStartDrag:function(e){
if(_286.mask){
...
_286.proxy=$("<div class=\"window-proxy\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;\" frameborder=\"0\"></div>").insertAfter(_286.window);
}
...
_286.pmask=$("<div class=\"window-proxy-mask\"><iframe style=\"position: absolute; z-index: -1; width: 100%; height: 100%; top: 0;left:0;scrolling:no;\" frameborder=\"0\"></div>").insertAfter(_286.window);
_286.pmask.css({zIndex:$.fn.window.defaults.zIndex++,left:0,top:0,width:'100%',height:'100%'});
if(_286.proxy){
_286.proxy.remove();
}
_286.proxy=$("<div class=\"window-proxy\"></div>").insertAfter(_286.window);
...
return $.extend({},$.fn.panel.parseOptions(_28e),$.parser.parseOptions(_28e,[{draggables:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
...
tool[0].onclick=eval(btn.handler||function(){return false;
});
...
function _2a4(_2a5){
var opts=$.extend({},$.messager.defaults,{modal:false,shadow:false,draggables:false,resizable:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},title:"",width:250,height:100,showType:"slide",showSpeed:600,msg:"",timeout:4000},_2a5);
...
//杨恒涛与2013年9月16日修改为下面一行代码，借用阴影效果代码解决menu被flex和activeX对象遮挡问题
...
if(col.cellClass){
_634.ss.set("."+col.cellClass,col.boxWidth>0?col.boxWidth+"px":"auto");//杨恒涛 2013年9月2日修改，原来为rule.style["width"]=col.boxWidth?col.boxWidth+"px":"auto";
}
};
};
function _636(_639){
...
var _91e=_91d.panel;
if(!opts.disabled){//杨恒涛修改，实现combo组件获取焦点时、鼠标点击时就弹出下拉选面板,源代码为：if(!opts.editable){
_916(_91c);
}else{
...
var aboveHeight = _925.offset().top;
var belowHeight =  $(window)._outerHeight()+$(document).scrollTop()-_925.offset().top-_925._outerHeight();
var maxHeight = belowHeight;
if(aboveHeight>belowHeight){
	maxHeight = aboveHeight;
}
if(opts.panelHeight=='auto'){
	if(_926._outerHeight()>maxHeight){
...
_a49.find("a.slider-handle").draggables({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
