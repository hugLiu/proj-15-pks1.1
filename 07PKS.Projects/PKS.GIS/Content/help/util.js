...
var nameListDataXml = "<document><Node name='name1' featureID='' layerID='' /><Node name='name2' featureID='' layerID='' /><Node name='name3' featureID='' layerID='' /></document>";
	...
	if(dataObj.length>1){
		for(var i=0;i<dataObj.length;i++){
			...
			if(node!=null && node!=""){
				...
				obj={"id":id,"text":name,"children":nodeData,"attributes":attributes,"state":"close"};
			}else{//iconCls
