...
namespace Jurassic.AppCenter
{
    ...
    public static class RefHelper
    {
        ...
        public static object GetPathProperty(object obj, string propertyPathName)
        {
        ...
        public static object LoadClass(string fullClassName, params object[] param)
        {
            var ass = LoadAssembly(fullClassName);
            if (ass == null) return null;
            return ass.CreateInstance(fullClassName, false, BindingFlags.Default, null, param, null, null);
        }
