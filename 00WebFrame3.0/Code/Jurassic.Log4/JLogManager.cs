...
{
    public class JLogManager : IJLogManager
    {
        /// <summary>
        /// The wrapper map to use to hold the <see cref="JLogImpl"/> objects
        /// </summary>
        private readonly WrapperMap s_wrapperMap;
        ...
        public IJLog Exists(string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public IJLog Exists(string domain, string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public IJLog Exists(Assembly assembly, string name)
        {
        ...
        public IJLog[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public IJLog[] GetCurrentLoggers(string domain)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public IJLog[] GetCurrentLoggers(Assembly assembly)
        {
        ...
        public IJLog GetLogger(string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public IJLog GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public IJLog GetLogger(Assembly assembly, string name)
        {
        ...
        /// <returns>the logger with the name specified</returns>
        public IJLog GetLogger(Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public IJLog GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public IJLog GetLogger(Assembly assembly, Type type)
        {
        ...
        private IJLog WrapLogger(ILogger logger)
        {
            return (IJLog) s_wrapperMap.GetWrapper(logger);
        }
        ...
        /// <returns>The wrapper for the logger specified</returns>
        private ILoggerWrapper WrapperCreationHandler(ILogger logger)
        {
            return new JLogImpl(logger);
        }
    }
}
