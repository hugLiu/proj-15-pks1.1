...
namespace PanGu
{
    ...
    public enum POS
    {
        ...
        /// 名词 名语素
        /// </summary>
        PT = 0x00100000,	//	名词 名语素

        /// <summary>
        /// 拟声词
        /// </summary>
        Media = 0x00080000,	//	拟声词
