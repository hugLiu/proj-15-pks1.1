...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n			<tr>\r\n				<td class=\"datatitle\">\r\n					<input name=\"linkid\" type=\"checkbox\" id=\"linkid" + currentlink["linkid"].ToString().Trim() + "\" value=\"" + currentlink["linkid"].ToString().Trim() + "\"/>\r\n					<span title=\"" + currentlink["linktitle"].ToString().Trim() + "\">" + currentlink["shortlinktitle"].ToString().Trim() + "</span> \r\n					<a href=\"usercpspacelinkedit.aspx?linkid=" + currentlink["linkid"].ToString().Trim() + "\">[编辑]</a>\r\n				</td>\r\n				<td style=\"text-align:left;\"><a href=\"" + currentlink["linkurl"].ToString().Trim() + "\" target=\"_blank\">" + currentlink["shortlinkurl"].ToString().Trim() + "</a></td>\r\n				<td style=\"text-align:left;\">" + currentlink["description"].ToString().Trim() + "&nbsp;</td>\r\n				<td><a href=\"###\" onclick=\"$('linkid" + currentlink["linkid"].ToString().Trim() + "').checked=true;$('linklist').submit();\">删除</a></td>\r\n			</tr>\r\n			");
	}	//end loop
