<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Forum.PageBase" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:19:07.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:19:07. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; 版块搜索\r\n	</div>\r\n</div>\r\n	");	string key = Utils.UrlDecode(DNTRequest.GetString("q")).ToLower().Trim();
	...
	foreach(ForumInfo subforum in forumlist)
	{
		subforum__loop__id++;
	...
	templateBuilder.Append(count.ToString());
	templateBuilder.Append(";\r\n	</");
	templateBuilder.Append("script>\r\n	");
	if (count==0&&key!="")
	{
	...
	templateBuilder.Append("\r\n	<div style=\"border-top:1px solid #D3E0EC;padding-top:20px;\"><input type=\"text\" size=\"40\" value=\"");
	templateBuilder.Append(Utils.HtmlEncode(key).ToString().Trim());
	templateBuilder.Append("\" id=\"f_key\" /><input type=\"button\" value=\"搜  索\" onclick=\"window.location='?q=' + escape($('f_key').value)\" /></div>\r\n	</div>\r\n</div>\r\n</div>\r\n");
