<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpcreaditstransferlog" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:19:00.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:19:00. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>转账与兑换记录</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n   ");
	...
	int creditslog__loop__id=0;
	foreach(DataRow creditslog in creditsloglist.Rows)
	{
		creditslog__loop__id++;

	templateBuilder.Append("\r\n		<tr>\r\n			<td>\r\n			");
	if (Utils.StrToInt(creditslog["uid"].ToString().Trim(), 0)==userid)
	{

	 aspxrewriteurl = this.UserInfoAspxRewrite(creditslog["fromto"].ToString().Trim());
	
	templateBuilder.Append("\r\n			<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" target=\"_blank\">" + creditslog["touser"].ToString().Trim() + "</a>\r\n			");
	}
	else
	{

	 aspxrewriteurl = this.UserInfoAspxRewrite(creditslog["uid"].ToString().Trim());
	
	templateBuilder.Append("\r\n			<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" target=\"_blank\">" + creditslog["fromuser"].ToString().Trim() + "</a>\r\n			");
	}	//end if

	templateBuilder.Append("\r\n			</td>\r\n			");	string sendcreditsword = ForumUtils.ConvertCreditAndAmountToWord(TypeConverter.ObjectToInt(creditslog["sendcredits"]),TypeConverter.ObjectToInt(creditslog["send"]));
	
	string receivecreditsword = ForumUtils.ConvertCreditAndAmountToWord(TypeConverter.ObjectToInt(creditslog["receivecredits"]),TypeConverter.ObjectToInt(creditslog["receive"]));
	
	templateBuilder.Append("\r\n			<td class=\"time\">" + creditslog["paydate"].ToString().Trim() + "</td>\r\n			<td>");
	templateBuilder.Append(sendcreditsword.ToString());
	templateBuilder.Append("</td>\r\n			<td>");
	templateBuilder.Append(receivecreditsword.ToString());
	templateBuilder.Append("</td>\r\n			<td>" + creditslog["operationinfo"].ToString().Trim() + "</td>\r\n		</tr>\r\n		");
	}	//end loop
