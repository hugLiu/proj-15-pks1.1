...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:39.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:39. 
	*/
	...
	templateBuilder.Append("	\r\n				<tr>\r\n					<td class=\"datatitle\"><input type=\"checkbox\" name=\"commentid\" id=\"commentid" + currentcomment["commentid"].ToString().Trim() + "\" value=\"" + currentcomment["commentid"].ToString().Trim() + "\" />\r\n				" + currentcomment["author"].ToString().Trim() + " 对 <a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/viewspacepost.aspx?postid=" + currentcomment["postid"].ToString().Trim() + "\" target=\"_blank\">" + currentcomment["posttitle"].ToString().Trim() + "</a> 发表评论</td>\r\n					<td>" + currentcomment["postdatetime"].ToString().Trim() + "</td>\r\n				</tr>\r\n				<tr>\r\n					<td colspan=\"2\">" + currentcomment["content"].ToString().Trim() + "</td>\r\n				</tr>\r\n				");
	}	//end loop
