...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n			<tr>\r\n				<td>\r\n				<input name=\"aid\" type=\"checkbox\" id=\"aid" + currentattachment["aid"].ToString().Trim() + "\" value=\"" + currentattachment["aid"].ToString().Trim() + "\"/>\r\n				<span id=\"layer" + currentattachment["aid"].ToString().Trim() + "\" onmouseover=\"showMenu(this.id, 0, 0, 1, 0);\"><a href=\"" + currentattachment["filename"].ToString().Trim() + "\">" + currentattachment["attachment"].ToString().Trim() + "</a></span>\r\n				");
	if (currentattachment["isimg"].ToString().Trim()=="True")
	{

	templateBuilder.Append("\r\n				<div id=\"layer" + currentattachment["aid"].ToString().Trim() + "_menu\" style=\"position: absolute;display:none\"><img src=\"" + currentattachment["filename"].ToString().Trim() + "\" onerror=\"this.onerror=null;this.src='';\" width=\"100\"/></div>\r\n				");
	}	//end if

	templateBuilder.Append("\r\n				</td>\r\n				<td>\r\n				<script language=\"javascript\" type=\"text/javascript\">\r\n				ShowFormatBytesStr(" + currentattachment["filesize"].ToString().Trim() + ");\r\n				</");
	templateBuilder.Append("script>\r\n				</td>\r\n				<td>" + currentattachment["downloads"].ToString().Trim() + "</td>\r\n				<td>" + currentattachment["postdatetime"].ToString().Trim() + "</td>\r\n				<td><a href=\"###\" onclick=\"$('aid" + currentattachment["aid"].ToString().Trim() + "').checked=true;$('attachlist').submit();\">删除</a></td>\r\n			</tr>\r\n			");
	}	//end loop
