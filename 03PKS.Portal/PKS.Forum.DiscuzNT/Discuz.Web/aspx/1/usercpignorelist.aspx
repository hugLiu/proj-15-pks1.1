<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpignorelist" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:19:11.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:19:11. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>黑名单</strong>\r\n    </div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n    ");
	...
	templateBuilder.Append("\r\n			<form id=\"postignorelist\" name=\"postignorelist\" method=\"post\" action=\"\">\r\n			<table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"个人资料\">\r\n				<caption>\r\n					如果某用户被加入到黑名单中，那么该用户给您发送的短消息将不会被接收。<br />\r\n					将多个用户添加到黑名单时需要用逗号(英文半角)分割，如“张三,李四,王五”。<br />\r\n					如需禁止接受所有用户发来的短消息，请设置为 \"");
	templateBuilder.Append(ignoreexample.ToString());
	templateBuilder.Append("\" (注意区分大小写)。<br />\r\n				</caption>\r\n				<tbody>\r\n				<tr>\r\n					<td>\r\n					<textarea name=\"ignorepm\" class=\"txtarea\" cols=\"40\" rows=\"10\" id=\"ignorepm\" onkeydown=\"if((event.ctrlKey && event.keyCode == 13) || (event.altKey && event.keyCode == 83)) document.getElementById('postignorelist').submit();\" style=\"width:80%;\">");
	templateBuilder.Append(user.Ignorepm.ToString().Trim());
	templateBuilder.Append("</textarea>\r\n					</td>\r\n				</tr>\r\n				<tr>\r\n					<td><input name=\"sendignorelist\" type=\"submit\" id=\"sendignorelist\" value=\"保存\" class=\"btn\"/></td>\r\n				</tr>\r\n				</tbody>\r\n			</table>\r\n			</form>\r\n            ");
	}	//end if
