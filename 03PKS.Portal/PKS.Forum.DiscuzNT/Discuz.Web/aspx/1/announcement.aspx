<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.announcement" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <strong>公告</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap s_clear\" id=\"wrap\">\r\n<div class=\"main\">\r\n");
	if (page_err==0)
	{
	...
	templateBuilder.Append("\r\n	<dl class=\"announce s_clear\">\r\n		<dt class=\"f_bold\"><a name=\"" + announcement["id"].ToString().Trim() + "\"></a>" + announcement["title"].ToString().Trim() + "</dt>\r\n		<dd>\r\n			");	 aspxrewriteurl = this.UserInfoAspxRewrite(announcement["posterid"].ToString().Trim());
	
	templateBuilder.Append("\r\n			<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" class=\"lightlink\">" + announcement["poster"].ToString().Trim() + "</a>  发表于: <span class=\"time\">");	templateBuilder.Append(Convert.ToDateTime(announcement["starttime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
	templateBuilder.Append("</span>\r\n			结束于:<span class=\"time\">");	templateBuilder.Append(Convert.ToDateTime(announcement["endtime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
	templateBuilder.Append("</span>\r\n		</dd>\r\n		<dd>\r\n			" + announcement["message"].ToString().Trim() + "\r\n		</dd>\r\n	</dl>\r\n	<hr class=\"solidline\"/>\r\n	");
	}	//end loop
