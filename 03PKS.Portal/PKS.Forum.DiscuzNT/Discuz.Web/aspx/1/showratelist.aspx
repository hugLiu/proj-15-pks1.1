<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.showratelist" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	int ratelog__loop__id=0;
	foreach(RateLogInfo ratelog in rateloglist)
	{
		ratelog__loop__id++;

	templateBuilder.Append("\r\n            <tbody>\r\n                <tr>\r\n                    <td style=\"width:80px\"><a href=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append(GetAvatarUrl(ratelog.Uid).ToString().Trim());
	templateBuilder.Append("\">");
	templateBuilder.Append(ratelog.UserName.ToString().Trim());
	templateBuilder.Append("</a></td>\r\n                    <td style=\"width:100px\">");
	templateBuilder.Append(ratelog.PostDateTime.ToString().Trim());
	templateBuilder.Append("</td>\r\n                    <td style=\"width:180px\">\r\n                    ");
	templateBuilder.Append(GetExtCreditName(ratelog.ExtCredits).ToString().Trim());
	templateBuilder.Append("<span class=\"xg2\">");
	templateBuilder.Append(GetScoreMark(ratelog.Score).ToString().Trim());
	templateBuilder.Append(ratelog.Score.ToString().Trim());
	templateBuilder.Append("</span>");
	templateBuilder.Append(GetExtCreditUnit(ratelog.ExtCredits).ToString().Trim());
	templateBuilder.Append("\r\n                    </td>\r\n                    <td>");
	templateBuilder.Append(ratelog.Reason.ToString().Trim());
	templateBuilder.Append("</td>\r\n                </tr>\r\n            </tbody>\r\n            ");
	}	//end loop

	templateBuilder.Append("\r\n        </table>\r\n    </div>\r\n    <div class=\"pages_btns cl\">\r\n		<div class=\"pages\">\r\n			<kbd>共");
	templateBuilder.Append(ratecount.ToString());
	templateBuilder.Append("条评分</kbd>");
