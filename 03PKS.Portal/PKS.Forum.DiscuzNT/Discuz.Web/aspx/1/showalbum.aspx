...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/album/images/button_seeit.gif\" alt=\"Silverlight相册展示\" /></a>\r\n		");
	}	//end if

	templateBuilder.Append("-->\r\n		</cite>\r\n		<h2 style=\"line-height:36px;height:36px;\">");
	templateBuilder.Append(album.Title.ToString().Trim());
	templateBuilder.Append("<strong><script type=\"text/javascript\">document.write(window.location);</");
	templateBuilder.Append("script></strong>(<a href=\"###\" onclick=\"setcopy(window.location.href.replace('###','') + '&page=");
	...
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/album/images/dotspace.gif\" />");
	...
	templateBuilder.Append("\"><img src=\"templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/album/images/user_info.gif\"  alt=\"用户信息:\"/>");
	templateBuilder.Append(album.Username.ToString().Trim());
	...
	templateBuilder.Append("\"><img src=\"templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/album/images/user_album.gif\" alt=\"用户相册\"/>");
	templateBuilder.Append(album.Username.ToString().Trim());
	...
	templateBuilder.Append("\" target=\"_blank\"><img src=\"templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/album/images/album_edit.gif\" />管理</a>\r\n			");
	}	//end if
	...
	templateBuilder.Append("\"><img src=\"templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/album/images/album_fav.gif\" alt=\"收藏\" title=\"收藏\" />收藏</a>\r\n			</p>\r\n		</div>\r\n		");
