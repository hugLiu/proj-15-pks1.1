<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpsentbox" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:47.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:47. 
	*/
	...
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append("favicon.ico\" type=\"image/x-icon\" />\r\n\r\n    <!-- PKS公共头 -->\r\n    <link href=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Content/bootstrap/css/bootstrap.min.css\" rel=\"stylesheet\">\r\n    <link href=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Content/styles/site.css\" rel=\"stylesheet\" />\r\n    <link href=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Content/styles/layout/header/head-nav-2.css\" rel=\"stylesheet\" />\r\n    <!--<link href=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Content/xvision/xvision.css\" rel=\"stylesheet\" />-->\r\n    <!-- PKS WebAPI脚本 -->\r\n    <!--<script type=\"text/javascript\" src=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Scripts/jquery-1.11.1.js\"></");
	templateBuilder.Append("script>-->\r\n    <!--<script type=\"text/javascript\" src=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Scripts/moment.2.18.1/moment.min.js\"></");
	templateBuilder.Append("script>-->\r\n    <script type=\"text/javascript\" src=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Scripts/PKSGlobalStore.js\"></");
	templateBuilder.Append("script>\r\n    <script>\r\n        pksGlobalStore.init(\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("\");\r\n    </");
	templateBuilder.Append("script>\r\n    <!-- PKS WebAPI脚本 -->\r\n    <script type=\"text/javascript\" src=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Content/PKSUI/vendor.js\"></");
	templateBuilder.Append("script>\r\n    <script type=\"text/javascript\" src=\"");
	templateBuilder.Append(webApiSiteUrl.ToString());
	templateBuilder.Append("/Content/PKSUI/PKSUI.js\"></");
	templateBuilder.Append("script>\r\n    <!-- PKS公共头 -->\r\n    ");
	if (pagename!="website.aspx")
	{

	templateBuilder.Append("\r\n    <link itemscope=\"\"  rel=\"stylesheet\" href=\"");
	...
	templateBuilder.Append("\r\n    <link type=\"text/css\" rel=\"stylesheet\" href=\"/redirect/site.css\" />\r\n    <script type=\"text/javascript\">\r\n        var creditnotice = '");
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>发件箱</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc s_clear\">\r\n	");
	...
	templateBuilder.Append("\r\n	<li class=\"current uc_app_hide\"><a href=\"usercpprofile.aspx?action=avatar\">设置头像</a></li>\r\n	");
	}
	else
	{

	templateBuilder.Append("\r\n	<li class=\"uc_app_hide\"><a href=\"usercpprofile.aspx?action=avatar\">设置头像</a></li>\r\n	");
	}	//end if
	...
	templateBuilder.Append("\r\n	<li class=\"current uc_app_hide\"><a href=\"usercpprofile.aspx\">个人资料</a></li>\r\n	");
	}
	else
	{

	templateBuilder.Append("\r\n	<li class=\"uc_app_hide\"><a href=\"usercpprofile.aspx\">个人资料</a></li>\r\n	");
	}	//end if
	...
	templateBuilder.Append("\r\n	<li class=\"current uc_app_hide\"><a href=\"usercpcreditspay.aspx\">积分</a></li>\r\n	");
	}
	else
	{

	templateBuilder.Append("\r\n	<li class=\"uc_app_hide\"><a href=\"usercpcreditspay.aspx\">积分</a></li>\r\n	");
	}	//end if
	...
	templateBuilder.Append("\r\n	<li class=\"current uc_app_hide\"><a href=\"usercpnewpassword.aspx\">更改密码</a></li>\r\n	");
	}
	else
	{

	templateBuilder.Append("\r\n	<li class=\"uc_app_hide\"><a href=\"usercpnewpassword.aspx\">更改密码</a></li>\r\n	");
	}	//end if
	...
	templateBuilder.Append("\r\n<div class=\"uc_header\">\r\n	<a class=\"btn_uc\" onclick=\"floatwin('open_postpm', this.href, 600, 410, '600,0');doane(event);\" href=\"usercppostpm.aspx\">+ 写新消息</a>	\r\n	<ul class=\"f_tab\">\r\n		<li ");
	...
	templateBuilder.Append("><a href=\"usercpinbox.aspx\">收件箱</a></li>\r\n		<li ");
	...
	templateBuilder.Append("><a href=\"usercpsentbox.aspx\">发件箱</a></li>\r\n		<li ");
	...
	templateBuilder.Append("><a href=\"usercpdraftbox.aspx\">草稿箱</a></li>\r\n		<li ");
	...
	templateBuilder.Append("><a href=\"usercpannouncepm.aspx\">公共消息");
	...
	templateBuilder.Append("><a href=\"usercpignorelist.aspx\">黑名单</a></li>\r\n		<li ");
	...
	templateBuilder.Append("><a id=\"notice\" onMouseOver=\"showMenu(this.id);\" onMouseOut=\"showMenu(this.id);\" onclick=\"javascript:window.location.href=this.href;\" href=\"usercpnotice.aspx\"><cite class=\"drop\">通知");
	if (newnoticecount>0)
	{
	...
	templateBuilder.Append("</cite></a></li>\r\n	</ul>\r\n</div>\r\n");
	}	//end if
	...
	templateBuilder.Append("\r\n	<li><a href=\"usercpnotice.aspx?filter=spacecomment\">");
	templateBuilder.Append(config.Spacename.ToString().Trim());
	...
	templateBuilder.Append("\r\n	<li><a href=\"usercpnotice.aspx?filter=albumcomment\">");
	templateBuilder.Append(config.Albumname.ToString().Trim());
	...
	templateBuilder.Append("\r\n	<li><a href=\"usercpnotice.aspx?filter=goodstrade\">商品交易</a></li>\r\n	<li><a href=\"usercpnotice.aspx?filter=goodsleaveword\">商品留言</a></li>	  \r\n");
	}	//end if
	...
	templateBuilder.Append("			  \r\n				<form id=\"pmform\" name=\"pmform\" method=\"post\" action=\"\">\r\n				<table cellspacing=\"0\" cellpadding=\"0\" class=\"pm_list\" summary=\"发件箱\">\r\n					<tbody>\r\n					");
	int pm__loop__id=0;
	foreach(PrivateMessageInfo pm in PrivateMessages.GetPrivateMessageCollection(userid,1,16,pageid,2))
	{
		pm__loop__id++;

	templateBuilder.Append("\r\n					<tr id=\"");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\">\r\n						<td class=\"msg_icon\"><img src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/pm_");
	templateBuilder.Append(pm.New.ToString().Trim());
	templateBuilder.Append(".gif\" ");
	if (pm.New==1)
	{

	templateBuilder.Append("title=\"未读\"");
	}
	else
	{

	templateBuilder.Append("title=\"已读\"");
	}	//end if

	templateBuilder.Append("/></td>\r\n						<td class=\"checkbox_toggle\"><input name=\"pmitemid\" id=\"id");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\" type=\"checkbox\" id=\"pmitemid\" value=\"");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\"/></td>\r\n						<td class=\"profile_pic\">\r\n						");	 aspxrewriteurl = this.UserInfoAspxRewrite(pm.Msgtoid);
	
	templateBuilder.Append("\r\n						<a class=\"avatar\" target=\"_blank\" href=\"");
	templateBuilder.Append(forumurl.ToString());
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\">\r\n						");	string avatarurl = Avatars.GetAvatarUrl(pm.Msgtoid,AvatarSize.Small);
	
	templateBuilder.Append("\r\n							<img width=\"48\" onerror=\"this.onerror=null;this.src='");
	templateBuilder.Append(forumpath.ToString());
	...
	templateBuilder.Append(pm.Msgto.ToString().Trim());
	templateBuilder.Append("</a>\r\n							</span>\r\n							");	string postdatetime = ForumUtils.ConvertDateTime(pm.Postdatetime);
	
	templateBuilder.Append("	\r\n							<span class=\"date\">");
	templateBuilder.Append(postdatetime.ToString());
	...
	templateBuilder.Append("><a href=\"usercpshowpm.aspx?pmid=");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\">");
	templateBuilder.Append(pm.Subject.ToString().Trim());
	templateBuilder.Append("</a></p>\r\n								<div class=\"snippet_wrap xg1\">\r\n									<a href=\"usercpshowpm.aspx?pmid=");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("\">");	templateBuilder.Append(Utils.GetUnicodeSubString(pm.Message,40,"..."));
	templateBuilder.Append("</a>\r\n								</div>\r\n							</div>\r\n						</td>\r\n						<td class=\"delete_msg\"><a href=\"###“ onclick=\"if (confirm('您确定要删除吗?')){ $('id");
	templateBuilder.Append(pm.Pmid.ToString().Trim());
	templateBuilder.Append("').checked=true;$('pmform').submit();}\"></a></td>\r\n					</tr>\r\n					");
	}	//end loop
	...
	templateBuilder.Append(usedmsgcount.ToString());
	templateBuilder.Append("条</em> <em>上限:");
	templateBuilder.Append(usergroupinfo.Maxpmnum.ToString().Trim());
	templateBuilder.Append("条</em> ");
	...
	templateBuilder.Append("\r\n			     	<div class=\"zerothreads\">发件箱暂无短信息</div>\r\n				  ");
	}	//end if
