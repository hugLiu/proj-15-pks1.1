<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.useradmin" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:34.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:34. 
	*/
	...
	templateBuilder.Append("\r\n	    <em id=\"return_mods\">");
	templateBuilder.Append(operationtitle.ToString());
	templateBuilder.Append("</em>\r\n	</h3>\r\n	<form id=\"moderate\" name=\"moderate\" method=\"post\" onsubmit=\"ajaxpost('moderate', 'return_mods', 'return_mods', 'onerror');return false;\" action=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("useradmin.aspx?infloat=1&action=banuser&uid=");
	templateBuilder.Append(operateduid.ToString());
	templateBuilder.Append("\">\r\n	    <div class=\"postbox\">\r\n		");
	if (action=="banuser")
	{

	templateBuilder.Append("\r\n		<div class=\"topicadminlow\" style=\"height:60px;\">\r\n			<label for=\"operatedusername\">被操作用户</label>:\r\n			");	 aspxrewriteurl = this.UserInfoAspxRewrite(operateduid);
	
	templateBuilder.Append("\r\n			<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" target=\"_blank\">");
	templateBuilder.Append(operatedusername.ToString());
	templateBuilder.Append("</a>\r\n		    <ul style=\"margin: 5px 0pt;\" class=\"inlinelist\">\r\n		        <li class=\"wide\"><label><input type=\"radio\" value=\"0\" name=\"bantype\" ");
	if (bantype==0)
	{
	...
	templateBuilder.Append(" />正常状态</label></li>\r\n                <li class=\"wide\"><label><input type=\"radio\" value=\"1\" name=\"bantype\" ");
	if (bantype==1)
	{
	...
	templateBuilder.Append(" />禁止发言</label></li>\r\n				<li class=\"wide\"><label><input type=\"radio\" value=\"2\" name=\"bantype\" ");
	if (bantype==2)
	{
	...
	templateBuilder.Append(" />禁止访问</label></li>\r\n				");
	if (bantype==3)
	{

	templateBuilder.Append("<li class=\"wide\"><label><input type=\"radio\" value=\"3\" name=\"bantype\" checked=\"checked\" />禁止IP</label></li>");
	}	//end if

	templateBuilder.Append("\r\n		    </ul>\r\n		</div>\r\n		<div class=\"topicadminlow\" style=\"clear:both;margin:8px 0;height:35px;\"><label for=\"banexpirynew\">过期日期</label>:");
	...
	templateBuilder.Append("\r\n		<div class=\"topicadminlog\">\r\n		    <h4>\r\n		        <span class=\"hasdropdownbtn y\"><a href=\"javascript:;\" class=\"dropdownbtn\" onclick=\"showselect(this, 'reason', 'reasonselect')\">^</a></span>\r\n		        操作说明:\r\n		    </h4>\r\n		    <p>\r\n			    <textarea onkeyup=\"seditor_ctlent(event, '$(\\'moderateform\\').submit()')\" class=\"txtarea\" name=\"reason\" id=\"reason\" onkeydown=\"if(this.value.length>200){ alert('操作原因不能多于200个字符');return false; }\"></textarea>\r\n		    </p>\r\n		    <ul style=\"display: none;\" id=\"reasonselect\">\r\n			    <li>广告/SPAM</li>\r\n			    <li>恶意灌水</li>\r\n			    <li>违规内容</li>\r\n			    <li>文不对题</li>\r\n			    <li>重复发帖</li>\r\n			    <li></li>\r\n			    <li>我很赞同</li>\r\n			    <li>精品文章</li>\r\n			    <li>原创内容</li>\r\n		    </ul>\r\n	    </div>\r\n	    <div class=\"topic_msg\">\r\n            <button name=\"modsubmit\" value=\"true\" type=\"submit\" class=\"submit\">提交</button>\r\n        </div>\r\n        </div>\r\n	</form>\r\n	</div>\r\n</div>\r\n");
	}
	else
	{
	...
	templateBuilder.Append(operationtitle.ToString());
	templateBuilder.Append("</h1>\r\n	<form id=\"moderate\" name=\"moderate\" method=\"post\">\r\n		");
	if (action=="banuser")
	{
	...
	templateBuilder.Append("\r\n		<div class=\"topicadminlog\">\r\n		    <h4>\r\n		        <span class=\"hasdropdownbtn right\"><a href=\"javascript:;\" class=\"dropdownbtn\" onclick=\"InFloat='floatlayout_mods';showselect(this, 'reason', 'reasonselect')\">^</a></span>\r\n		        操作说明:\r\n		    </h4>\r\n		    <p>\r\n			    <textarea onkeyup=\"seditor_ctlent(event, '$(\\'moderateform\\').submit()')\" class=\"txtarea\" name=\"reason\" id=\"reason\" onkeydown=\"if(this.value.length>200){ alert('操作原因不能多于200个字符');return false; }\"></textarea>\r\n		    </p>\r\n		    <ul style=\"display: none;\" id=\"reasonselect\">\r\n			    <li>广告/SPAM</li>\r\n			    <li>恶意灌水</li>\r\n			    <li>违规内容</li>\r\n			    <li>文不对题</li>\r\n			    <li>重复发帖</li>\r\n			    <li></li>\r\n			    <li>我很赞同</li>\r\n			    <li>精品文章</li>\r\n			    <li>原创内容</li>\r\n		    </ul>\r\n	    </div>\r\n	    <div class=\"topic_msg\">\r\n            <p style=\"float: right;\">\r\n                <input type=\"checkbox\" class=\"checkbox\" id=\"sendmessage\" name=\"sendmessage\"/> <label for=\"sendreasonpm\">通知作者</label>  \r\n            </p>\r\n            <button name=\"modsubmit\" value=\"true\" type=\"submit\" class=\"submit\">提交</button>\r\n        </div>\r\n	</form>\r\n	</div>\r\n</div>\r\n");
	}	//end if
