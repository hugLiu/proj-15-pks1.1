<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpnotice" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:33.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:33. 
	*/
	...
	templateBuilder.Append("\r\n<script type=\"text/javascript\" src=\"");
	templateBuilder.Append(jsdir.ToString());
	templateBuilder.Append("/template_usercpnotice.js\"></");
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>通知</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n    ");
	...
	int noticeinfo__loop__id=0;
	foreach(NoticeInfo noticeinfo in noticeinfolist)
	{
		noticeinfo__loop__id++;

	templateBuilder.Append("\r\n				<dl>\r\n					<dd class=\"m mbn\">\r\n                        ");
	if (noticeinfo.Posterid==0)
	{

	templateBuilder.Append("\r\n						    <img alt=\"systempm\" src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/systempm.gif\">\r\n                        ");
	}
	else
	{

	string avatarurl = Avatars.GetAvatarUrl(noticeinfo.Posterid,AvatarSize.Small);
	
	templateBuilder.Append("\r\n				            <img src=\"");
	templateBuilder.Append(avatarurl.ToString());
	templateBuilder.Append("\" onerror=\"this.onerror=null;this.src='");
	templateBuilder.Append(forumpath.ToString());
	templateBuilder.Append("images/common/noavatar_small.gif'\"  alt=\"头像\" width=\"48\" height=\"48\"/>\r\n					    ");
	}	//end if

	templateBuilder.Append("\r\n                    </dd>\r\n					<dt>\r\n						");	string postdatetime = ForumUtils.ConvertDateTime(noticeinfo.Postdatetime);
	
	templateBuilder.Append("	\r\n						<span class=\"xg1\">");
	templateBuilder.Append(postdatetime.ToString());
	templateBuilder.Append("</span>\r\n					</dt>\r\n					<dd class=\"ntc_body\">\r\n						");	string note = UBB.ParseUrl(noticeinfo.Note);
	
	templateBuilder.Append("\r\n						");
	templateBuilder.Append(note.ToString());
	templateBuilder.Append("\r\n					</dd>\r\n				</dl>\r\n				");
	}	//end loop
