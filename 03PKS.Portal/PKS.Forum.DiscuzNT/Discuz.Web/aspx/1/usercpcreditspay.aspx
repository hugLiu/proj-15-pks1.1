...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:51.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:51. 
	*/
	...
	templateBuilder.Append("\r\n							<option value=\"" + extcredits["id"].ToString().Trim() + "\">" + extcredits["name"].ToString().Trim() + "</option>\r\n							");
	}	//end loop

	templateBuilder.Append("\r\n						</select>\r\n					</div>\r\n					<script type=\"text/javascript\">simulateSelect('extcredits1');</");
	...
	templateBuilder.Append("\r\n							<option value=\"" + extcredits2["id"].ToString().Trim() + "\">" + extcredits2["name"].ToString().Trim() + "</option>\r\n							");
	}	//end loop

	templateBuilder.Append("\r\n						</select>\r\n					</div>\r\n					<script type=\"text/javascript\">simulateSelect('extcredits2');</");
	templateBuilder.Append("script>\r\n\r\n					<span class=\"z\"><a href=\"###\" onclick=\"if($('postform').extcredits1.options[$('postform').extcredits1.selectedIndex].value != 0 && $('postform').extcredits2.options[$('postform').extcredits2.selectedIndex].value != 0){alert('接收者的所得为 '+$('postform').extcredits2.options[$('postform').extcredits2.selectedIndex].text + ':'+Math.round($('postform').paynum.value*(creditsrate[$('postform').extcredits1.options[$('postform').extcredits1.selectedIndex].value]/creditsrate[$('postform').extcredits2.options[$('postform').extcredits2.selectedIndex].value] *(1-");
	templateBuilder.Append(creditstax.ToString());
	templateBuilder.Append("))*100)/100)}else{alert('请完整填写和选择进行兑换的积分!')}\" >计算</a></span>\r\n				</td>\r\n			</tr>\r\n			<tr>\r\n				<th>验证用户密码</th>\r\n				<td><input name=\"password\" type=\"password\" id=\"password\" size=\"20\" class=\"txt\"/></td>\r\n			</tr>\r\n			<tr>\r\n				<td colspan=\"2\">\r\n					<button type=\"submit\" name=\"Submit\" class=\"pn\"><span>确定</span></button>\r\n				</td>\r\n			</tr>\r\n			</tbody>\r\n			</table>\r\n			</form>\r\n	");
	}	//end if
