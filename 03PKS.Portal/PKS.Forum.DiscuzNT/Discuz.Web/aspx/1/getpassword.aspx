<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.getpassword" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <strong>密码找回</strong>\r\n	</div>\r\n</div>\r\n");
	}	//end if
	...
	templateBuilder.Append("\r\n	<h3 class=\"flb\"><em id=\"returngetpwdmessage\">密码找回</em><span><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('getpassword')\" title=\"关闭\">关闭</a></span></h3>\r\n	<div id=\"succeedmessage\" class=\"c cl\" style=\"display:none\"></div>\r\n	<form id=\"form3\" name=\"form3\" method=\"post\" onsubmit=\"javascript:$('form3').action='");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("getpassword.aspx?infloat=1&';ajaxpost('form3', 'returngetpwdmessage', 'returngetpwdmessage', 'onerror');return false;\" action=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("getpassword.aspx?infloat=1&\">\r\n");
	}	//end if
	...
	templateBuilder.Append("\r\n				<a href=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("register.aspx\"  onclick=\"hideWindow('getpassword');showWindow('register', this.href);\" class=\"xg2\">立即注册</a>\r\n				");
	}
	else
	{
	...
	templateBuilder.Append("\r\n				<a onclick=\"hideWindow('getpassword');showWindow('login', this.href);\" href=\"");
	templateBuilder.Append(rooturl.ToString());
	...
	templateBuilder.Append("\r\n				<a href=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("login.aspx\" title=\"返回登录\" class=\"xg2\">返回登录</a>\r\n				");
	}	//end if

	templateBuilder.Append("\r\n			</p>\r\n		</div>\r\n	</div>\r\n	<p class=\"fsb pns cl\">\r\n		<span id=\"reginfo_b_btn\">\r\n			<button name=\"login\" type=\"submit\" id=\"login\"  tabindex=\"1\"  ");
	if (infloat!=1)
	{
