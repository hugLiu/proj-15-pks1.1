...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n				<tr>\r\n					<td><input name=\"categoryid\" type=\"checkbox\" id=\"categoryid" + currentcategory["categoryid"].ToString().Trim() + "\" value=\"" + currentcategory["categoryid"].ToString().Trim() + "\"/>" + currentcategory["title"].ToString().Trim() + " <a href=\"usercpspacecategoryedit.aspx?categoryid=" + currentcategory["categoryid"].ToString().Trim() + "\">[编辑]</a>\r\n					</td>\r\n					<td>" + currentcategory["shortdescription"].ToString().Trim() + "&nbsp;</td>\r\n					<td>" + currentcategory["categorycount"].ToString().Trim() + "</td>\r\n					<td>" + currentcategory["displayorder"].ToString().Trim() + "</td>\r\n					<td><a href=\"###\" onclick=\"$('categoryid" + currentcategory["categoryid"].ToString().Trim() + "').checked=true;$('catelist').submit();\">删除</a></td>\r\n				</tr>\r\n				");
	}	//end loop
