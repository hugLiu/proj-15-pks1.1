<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpcreditsbuy" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:59.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:59. 
	*/
	...
	templateBuilder.Append(config.Mincreditstobuy.ToString().Trim());
	templateBuilder.Append("){\r\n	                alert('您购买的积分数超过了系统要求的最低数量，无法购买');\r\n	                return false;\r\n	            }\r\n	            if(");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	templateBuilder.Append(">0&&amount>");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	...
	templateBuilder.Append(config.Cashtocreditrate.ToString().Trim());
	templateBuilder.Append(";\r\n	                if(amount%1!=0){\r\n	                    $('rmbmsg').style.color = '#FF0000';\r\n	                    $('rmbmsg').innerHTML = '购买的积分数必须是整数';\r\n	                }\r\n	                else if(amount<");
	templateBuilder.Append(config.Mincreditstobuy.ToString().Trim());
	templateBuilder.Append("){\r\n	                    $('rmbmsg').style.color = '#FF0000';\r\n	                    $('rmbmsg').innerHTML = '系统规定您至少应购买");
	templateBuilder.Append(config.Mincreditstobuy.ToString().Trim());
	templateBuilder.Append("个积分';\r\n	                }\r\n	                else if(");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	templateBuilder.Append(">0&&amount>");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	templateBuilder.Append("){\r\n	                     $('rmbmsg').style.color = '#FF0000';\r\n	                     $('rmbmsg').innerHTML = '系统规定您至多可以购买");
	templateBuilder.Append(config.Maxcreditstobuy.ToString().Trim());
	...
	templateBuilder.Append(creditstransname.ToString());
	templateBuilder.Append("&nbsp;<input name=\"paycredits\" type=\"text\" id=\"paycredits\" size=\"3\" class=\"txt\" onkeyup=\"ShowPayRMB();\"/> &nbsp;");
	templateBuilder.Append(creditstransunit.ToString());
	templateBuilder.Append("&nbsp;<span id=\"rmbmsg\" style=\"color:#FF0000\"></span></td>\r\n                </tr>\r\n                <tr>\r\n	                <th>选择支付平台</th>\r\n	                <td>\r\n		                <input id=\"paytype\" type=\"hidden\" value=\"alipay\" />\r\n		                <input id=\"paytype1\" name=\"paytype\" value=\"alipay\" type=\"radio\" checked=\"checked\" onclick=\"$('paytype').value=this.value;\" style=\" margin-top:-3px;\"/><img src=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("images/epayment/alipay_logo.gif\" style=\" vertical-align:middle;\" />\r\n	                </td>\r\n                </tr>\r\n                <tr>\r\n	                <td colspan=\"2\">\r\n		                <button type=\"button\" class=\"pn\" onclick=\"RedirectPayPage();\"><span>点击充值</span></button>\r\n	                </td>\r\n                </tr>\r\n            </tbody>\r\n        </table>\r\n	");
	}	//end if
