...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:55.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:55. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>论坛设置</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("\r\n						<option value=\"" + template["templateid"].ToString().Trim() + "\" ");
	...
	templateBuilder.Append("\r\n					</select>\r\n				</div>\r\n				<script type=\"text/javascript\">simulateSelect('templateid');</");
	...
	templateBuilder.Append("/>20\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<th>是否隐身</th>\r\n			<td>\r\n				<input type=\"radio\" name=\"invisible\" value=\"1\" ");
	if (user.Invisible==1)
	{
	...
	templateBuilder.Append("ID=\"Radio3\"/>是\r\n				<input type=\"radio\" name=\"invisible\" value=\"0\" ");
	if (user.Invisible==0)
	{
	...
	templateBuilder.Append("ID=\"Radio4\"/>否\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<th>短消息接收</th>\r\n			<td>\r\n			<input id=\"receiveuser\" type=\"checkbox\" name=\"receivesetting\" value=\"2\" ");
