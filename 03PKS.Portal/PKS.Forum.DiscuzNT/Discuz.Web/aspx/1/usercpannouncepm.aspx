<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpannouncepm" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:19:04.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:19:04. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>公共消息</strong>\r\n    </div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n    ");
	...
	if (announcepmlist.Count==0)
	{

	templateBuilder.Append("\r\n					<div class=\"zerothreads\">暂无新的公共消息</div> \r\n				");
	}
	else
	{

	templateBuilder.Append("\r\n					<table cellspacing=\"0\" cellpadding=\"0\" class=\"pm_list\" summary=\"公共消息\" width=\"100%\">\r\n					<tbody>\r\n					");
	int announcepm__loop__id=0;
	foreach(PrivateMessageInfo announcepm in announcepmlist)
	{
		announcepm__loop__id++;

	templateBuilder.Append("\r\n						<tr>\r\n							<td class=\"msg_icon\"><img alt=\"公共消息\" src=\"");
	templateBuilder.Append(imagedir.ToString());
	templateBuilder.Append("/announcement.gif\"/></td>\r\n							<td width=\"20%\">");
	templateBuilder.Append(announcepm.Subject.ToString().Trim());
	templateBuilder.Append("</td>\r\n							<td width=\"60%\">");
	templateBuilder.Append(announcepm.Message.ToString().Trim());
	templateBuilder.Append("</td>\r\n							");	string postdatetime = ForumUtils.ConvertDateTime(announcepm.Postdatetime);
	
	templateBuilder.Append("	\r\n							<td class=\"name_and_date\"><span class=\"date\">");
