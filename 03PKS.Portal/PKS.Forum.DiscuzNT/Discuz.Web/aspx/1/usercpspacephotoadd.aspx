...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\r\n	<form action=\"\" method=\"post\" enctype=\"multipart/form-data\">\r\n	<div id=\"freePhotoSize\" style=\"padding-bottom:10px;\"></div>\r\n	");	string tabnum = "1,2,3,4,5,6";
	
	char comma = ',';
	

	int num__loop__id=0;
	foreach(string num in tabnum.Split(comma))
	{
		num__loop__id++;

	templateBuilder.Append("\r\n	<table id=\"tab");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"增加图片");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" ");
	if (num!="1")
	{
	...
	templateBuilder.Append(">\r\n	<tbody>\r\n		<tr>\r\n			<th>标题</th>\r\n			<td><input name=\"phototitle");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" type=\"text\" id=\"phototitle");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" size=\"25\" class=\"txt\"/></td>\r\n		</tr>\r\n		<tr>\r\n			<th>选择图片</th>\r\n			<td>\r\n				<input type=\"file\" id=\"photo");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" onchange=\"PhotoView(");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append(")\" size=\"50\" name=\"photo");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\">\r\n			</td>\r\n		</tr>\r\n		<tr>\r\n			<th>描述</th>\r\n			<td><textarea name=\"description");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" rows=\"2\" class=\"txtarea\" cols=\"50\"></textarea></td>\r\n		</tr>\r\n		<tr>\r\n			<th></th>\r\n			<td><span id=\"td");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\"><img src=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/manage/images/invalid.gif\" width=\"100\" height=\"75\" id=\"view");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\"></span></td>\r\n		</tr>\r\n		");
	if (config.Enabletag==1)
	{

	templateBuilder.Append("\r\n		<tr>\r\n			<th>标签</th>\r\n			<td><input name=\"phototag");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" type=\"text\" id=\"phototag");
	templateBuilder.Append(num.ToString());
	templateBuilder.Append("\" size=\"25\" class=\"txt\"></td>\r\n		</tr>\r\n		");
	}	//end if
