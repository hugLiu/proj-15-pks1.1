...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:19:06.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:19:06. 
	*/
	...
	templateBuilder.Append("</a></cite>\r\n			<cite>");	templateBuilder.Append(Convert.ToDateTime(__spacepostrecommend.Postdatetime).ToString("yyyy-MM-dd"));
	...
	templateBuilder.Append("\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__spacepostrecommend.Title),70,"..."));
	...
	templateBuilder.Append("\r\n			<li>\r\n			<cite>( " + __spacepostbyviews["views"].ToString().Trim() + " )</cite>\r\n			· <a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/viewspacepost.aspx?postid=" + __spacepostbyviews["postid"].ToString().Trim() + "\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__spacepostbyviews["title"].ToString().Trim()),40,"..."));
	templateBuilder.Append("</a>\r\n			</li>\r\n			");
	}	//end if
	...
	templateBuilder.Append("\r\n			<li>\r\n			<cite>( " + __spacepostbycomment["commentcount"].ToString().Trim() + " )</cite>\r\n			· <a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/viewspacepost.aspx?postid=" + __spacepostbycomment["postid"].ToString().Trim() + "\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__spacepostbycomment["title"].ToString().Trim()),40,"..."));
	templateBuilder.Append("</a>\r\n			</li>\r\n			");
	}	//end if
	...
	templateBuilder.Append("space/?uid=");
	templateBuilder.Append(__spaceconfig.Userid.ToString().Trim());
	templateBuilder.Append("\" target=\"_blank\">");	templateBuilder.Append(Utils.GetUnicodeSubString(__spaceconfig.Spacetitle,35,"..."));
	templateBuilder.Append("</a></h3>\r\n				<p><a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/viewspacepost.aspx?postid=");
	templateBuilder.Append(__spaceconfig.Postid.ToString().Trim());
	templateBuilder.Append("\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__spaceconfig.Posttitle),35,"..."));
	...
	templateBuilder.Append("/images/noavatar_small.gif';\"/>\r\n			</a>\r\n			<h3><a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/?uid=" + __topcommentcountspaceinfo["userid"].ToString().Trim() + "\" target=\"_blank\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__topcommentcountspaceinfo["spacetitle"].ToString().Trim()),35,"..."));
	templateBuilder.Append("</a></h3>\r\n			<p><a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/viewspacepost.aspx?postid=" + __topcommentcountspaceinfo["postid"].ToString().Trim() + "\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__topcommentcountspaceinfo["posttitle"].ToString().Trim()),35,"..."));
	templateBuilder.Append("</a></p>\r\n			<p>日志:<em>" + __topcommentcountspaceinfo["postcount"].ToString().Trim() + "</em>   最后更新:<em>");	templateBuilder.Append(Convert.ToDateTime(__topcommentcountspaceinfo["updatedatetime"].ToString().Trim()).ToString("yyyy-MM-dd"));
	...
	templateBuilder.Append("/images/noavatar_small.gif';\"/>\r\n			</a>\r\n			<h3><a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/?uid=" + __topvisitedtimesspaceinfo["userid"].ToString().Trim() + "\"  target=\"_blank\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__topvisitedtimesspaceinfo["spacetitle"].ToString().Trim()),35,"..."));
	templateBuilder.Append("</a></h3>\r\n			<p><a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/viewspacepost.aspx?postid=" + __topvisitedtimesspaceinfo["postid"].ToString().Trim() + "\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__topvisitedtimesspaceinfo["posttitle"].ToString().Trim()),35,"..."));
	templateBuilder.Append("</a></p>\r\n			<p>日志:<em>" + __topvisitedtimesspaceinfo["postcount"].ToString().Trim() + "</em>   最后更新:<em>");	templateBuilder.Append(Convert.ToDateTime(__topvisitedtimesspaceinfo["updatedatetime"].ToString().Trim()).ToString("yyyy-MM-dd"));
	templateBuilder.Append("</em></p>\r\n		</li>\r\n		");
	}	//end if
	...
	templateBuilder.Append("script>\r\n	<div class=\"sidebox\">\r\n		<h4>热门标签</h4>\r\n		<ul id=\"spacehottags\">\r\n			<script type=\"text/javascript\" src=\"cache/hottags_space_cache_jsonp.txt\" onerror=\"this.onerror=null;getajaxspacehottags();\"></");
	templateBuilder.Append("script>\r\n		</ul>\r\n	</div>\r\n	");
	}	//end if
	...
	templateBuilder.Append(" 						\r\n				<li><a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/?uid=" + __space["userid"].ToString().Trim() + "\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__space["spacetitle"].ToString().Trim()),30,"..."));
	templateBuilder.Append("</a></li>\r\n			");
	}	//end loop
	...
	templateBuilder.Append("\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__newtopicinfo["title"].ToString().Trim()),30,"..."));
	templateBuilder.Append("</a></li>\r\n		");
	}	//end loop
	...
	templateBuilder.Append("\r\n			<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\">");	templateBuilder.Append(Utils.GetUnicodeSubString(Discuz.Common.Utils.HtmlEncode(__hottopicinfo["title"].ToString().Trim()),30,"..."));
	templateBuilder.Append("</a></li>\r\n		");
	}	//end loop
