<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpcreditspayoutlog" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>积分支出记录</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	templateBuilder.Append("\r\n				<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\" target=\"_blank\">" + paylog["forumname"].ToString().Trim() + "</a></td>\r\n			<tdclass=\"time\">" + paylog["buydate"].ToString().Trim() + "</td>\r\n			<td>" + paylog["amount"].ToString().Trim() + "</td>\r\n			<td>" + paylog["netamount"].ToString().Trim() + "</td>\r\n		</tr>\r\n		</tbody>\r\n		");
	}	//end loop
