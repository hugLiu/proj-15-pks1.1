<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.favorites" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(" &raquo; ");	 aspxrewriteurl = this.ShowForumAspxRewrite(forumid,0);
	
	templateBuilder.Append("\r\n		<a href=\"");
	templateBuilder.Append(aspxrewriteurl.ToString());
	templateBuilder.Append("\">");
	templateBuilder.Append(topictitle.ToString());
	templateBuilder.Append("</a> &raquo; <strong>收藏主题</strong>\r\n	");
	}	//end if


	if (config.Enablealbum==1 && albumid!=-1)
	{
