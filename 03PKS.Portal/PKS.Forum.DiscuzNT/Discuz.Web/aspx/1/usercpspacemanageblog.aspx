...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:44.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:44. 
	*/
	...
	templateBuilder.Append("\r\n			<tr>\r\n				<td>\r\n				<input name=\"postid\" type=\"checkbox\" id=\"blog" + currentblog["postid"].ToString().Trim() + "\" value=\"" + currentblog["postid"].ToString().Trim() + "\"/>\r\n				<a href=\"");
	templateBuilder.Append(spaceurl.ToString());
	templateBuilder.Append("space/viewspacepost.aspx?postid=" + currentblog["postid"].ToString().Trim() + "\" title=\"" + currentblog["title"].ToString().Trim() + "\" target=\"_blank\">" + currentblog["shorttitle"].ToString().Trim() + "</a>\r\n				<a href=\"usercpspaceeditblog.aspx?postid=" + currentblog["postid"].ToString().Trim() + "\">[编辑]</a>\r\n				</td>\r\n				<td>" + currentblog["category"].ToString().Trim() + "</td>\r\n				<td>" + currentblog["postdatetime"].ToString().Trim() + "</td>\r\n				<td>" + currentblog["commentcount"].ToString().Trim() + "</td>\r\n				<td><a href=\"###\" onclick=\"$('blog" + currentblog["postid"].ToString().Trim() + "').checked=true;$('bloglist').submit();\">删除</a></td>\r\n			</tr>\r\n			");
	}	//end loop
