<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.usercpdraftbox" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:48.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:48. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>草稿箱</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n	");
	...
	int pm__loop__id=0;
	foreach(PrivateMessageInfo pm in PrivateMessages.GetPrivateMessageCollection(userid,2,16,pageid,2))
	{
		pm__loop__id++;
	...
	templateBuilder.Append(maxmsg.ToString());
