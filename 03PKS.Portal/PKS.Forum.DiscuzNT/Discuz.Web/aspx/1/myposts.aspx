...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>我的帖子</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc c1\">\r\n	");
	...
	templateBuilder.Append("><a href=\"mytopics.aspx\">我的主题</a></li>\r\n	<li ");
	...
	templateBuilder.Append("><a href=\"myposts.aspx\">我的帖子</a></li>\r\n	<li ");
	if (pagename=="search.aspx?posterid=current&type=digest")
	{

	templateBuilder.Append(" class=\"cur_tab\"");
	}	//end if

	templateBuilder.Append("><a href=\"search.aspx?posterid=current&type=digest&searchsubmit=1\">我的精华</a></li>\r\n</ul>\r\n");
	}	//end if
	...
	templateBuilder.Append(".gif\" alt=\"图例\"/></a>\r\n				");
	}	//end if
	...
	templateBuilder.Append(".gif\" alt=\"图例\" />");
	}
	else
	{
	...
	templateBuilder.Append("</a></td>\r\n				");	string lastpost = ForumUtils.ConvertDateTime(topic.Lastpost);
	
	templateBuilder.Append("	\r\n			<td><span class=\"time\"><a href=\"showtopic.aspx?topicid=");
	templateBuilder.Append(topic.Tid.ToString().Trim());
	templateBuilder.Append("&page=end\">");
	templateBuilder.Append(lastpost.ToString());
	templateBuilder.Append("</a> by ");
	if (topic.Lastposterid!=-1)
	{

	templateBuilder.Append("<a href=\"userinfo-");
	templateBuilder.Append(topic.Lastposterid.ToString().Trim());
