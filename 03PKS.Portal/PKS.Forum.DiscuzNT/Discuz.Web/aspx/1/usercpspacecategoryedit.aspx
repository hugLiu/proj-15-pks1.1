<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Space.Pages.usercpspacecategoryedit" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:19:08.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:19:08. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercp.aspx\">用户中心</a> &raquo; <strong>编辑日志分类</strong>\r\n	</div>\r\n</div>\r\n<script type=\"text/javascript\">\r\nfunction checkform()\r\n{\r\n	if(document.getElementById(\"title\").value == \"\")\r\n	{\r\n		alert(\"分类名称为空\");\r\n		document.getElementById(\"title\").focus();\r\n		return false;\r\n	}\r\n	if(document.getElementById(\"categorydescription\").value.length > 1000)\r\n	{\r\n		alert(\"分类描述长度最大为1000字\"); \r\n		return false;\r\n	}\r\n	if(!(/^\\d+$/.test(document.getElementById(\"displayorder\").value)))\r\n	{\r\n		alert(\"分类序号必须是整数\");\r\n		document.getElementById(\"displayorder\").focus();\r\n		return false;\r\n	}\r\n	return true;\r\n}\r\n</");
	...
	templateBuilder.Append(spacecategoryinfo.Title.ToString().Trim());
	templateBuilder.Append("\" size=\"40\" maxlength=\"50\" class=\"txt\"/></td>\r\n				</tr>\r\n				<tr>\r\n					<th>分类描述</th>\r\n					<td><textarea name=\"description\" cols=\"50\" rows=\"6\" id=\"categorydescription\" class=\"txtarea\">");
	templateBuilder.Append(spacecategoryinfo.Description.ToString().Trim());
	templateBuilder.Append("</textarea></td>\r\n				</tr>\r\n				<tr>\r\n					<th>分类序号</th>\r\n					<td><input name=\"displayorder\" type=\"text\" id=\"displayorder\" value=\"");
	templateBuilder.Append(spacecategoryinfo.Displayorder.ToString().Trim());
	templateBuilder.Append("\" size=\"2\" maxlength=\"2\" class=\"txt\"/></td>\r\n				</tr>\r\n				<tr>\r\n					<th></th>\r\n					<td>\r\n						<button type=\"submit\" name=\"Submit\" onclick=\"return checkform();\"><span>确定</span></button>\r\n					</td>\r\n				</tr>\r\n				</tbody>\r\n			</table>\r\n			</form>\r\n		");
	}	//end if
