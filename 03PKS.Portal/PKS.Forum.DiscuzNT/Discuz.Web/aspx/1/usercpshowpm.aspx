...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:50.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:50. 
	*/
	...
	templateBuilder.Append(config.Forumtitle.ToString().Trim());
	templateBuilder.Append("</a> &raquo; <a href=\"usercpprofile.aspx\">用户中心</a> &raquo; <strong>查看短消息</strong>\r\n	</div>\r\n</div>\r\n<div class=\"wrap uc cl\">\r\n    ");
	...
	templateBuilder.Append("<span class=\"time\" style=\"padding-left: 10px\">");
	templateBuilder.Append(postdatetime.ToString());
	templateBuilder.Append("</span></li>\r\n			<li><cite>发送人:");
	templateBuilder.Append(msgfrom.ToString());
	...
	templateBuilder.Append("script>\r\n		<div class=\"notefilter\">\r\n			<a href=\"usercpinbox.aspx\">返回列表</a>\r\n			<a href=\"usercppostpm.aspx?action=re&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\">回复</a>\r\n			<a href=\"usercppostpm.aspx?action=fw&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\">转发</a>\r\n			<a href=\"usercpshowpm.aspx?action=noread&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\">标记为未读</a>\r\n			<a href=\"usercpshowpm.aspx?action=delete&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\"  onclick=\"return confirm('您确定要删除吗?')\">删除</a>\r\n		</div>\r\n		");
	if (canreplypm)
	{

	templateBuilder.Append("\r\n		<form id=\"postpm\" name=\"postpm\" method=\"post\" action=\"usercppostpm.aspx?action=re&amp;pmid=");
	templateBuilder.Append(pmid.ToString());
	templateBuilder.Append("\" style=\"display:none;\">\r\n			<table cellspacing=\"0\" cellpadding=\"0\" class=\"tfm\" summary=\"个人资料\">\r\n			<tbody>\r\n			<tr>\r\n				<th>接件人</th>\r\n				<td>\r\n					<input name=\"msgto\" type=\"text\" id=\"msgto\" value=\"");
	...
	templateBuilder.Append(resubject.ToString());
	templateBuilder.Append("\" size=\"40\"  class=\"txt\"/>\r\n				</td>\r\n			</tr>\r\n			<tr>\r\n				<th>内容</th>\r\n				<td>\r\n					<textarea name=\"message\" cols=\"80\" rows=\"20\" id=\"message\" onkeydown=\"if((event.ctrlKey && event.keyCode == 13) || (event.altKey && event.keyCode == 83)) document.getElementById('postpm').submit();\" class=\"txtarea\">");
	templateBuilder.Append(remessage.ToString());
