<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.referrer" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2018/2/5 星期一 下午 4:18:52.
		本页面代码由Discuz!NT模板引擎生成于 2018/2/5 星期一 下午 4:18:52. 
	*/
	...
	templateBuilder.Append("/css.css\" type=\"text/css\" media=\"all\" />\r\n<script src=\"javascript/referrer.js\"></");
	templateBuilder.Append("script>\r\n");
	if (page_err==0)
	{
	...
	templateBuilder.Append("\r\n	<div id=\"floatlayout_referrer\" class=\"float\" style=\"width: 600px; height: 410px;\">\r\n	");
	}
	else
	{

	templateBuilder.Append("\r\n	<div id=\"floatlayout_referrer\" class=\"float\">\r\n	");
	}	//end if

	templateBuilder.Append("\r\n	<h3 class=\"float_ctrl\">\r\n		<em id=\"returnmessage\">推荐</em>\r\n		");
	if (infloat==1)
	{

	templateBuilder.Append("\r\n			<span>\r\n				<a id=\"creditlink\" href=\"javascript:;\"></a>\r\n				<a title=\"关闭\" onclick=\"floatwin('close_referrer')\" class=\"float_close\" href=\"javascript:;\">关闭</a>\r\n			</span>\r\n		");
	}	//end if
	...
	templateBuilder.Append("\r\n		<form method=\"post\" name=\"referrerform\" id=\"referrerform\" action=\"");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("referrer.aspx?infloat=1&\" enctype=\"multipart/form-data\" onsubmit=\"return validatereferrer();\">	\r\n		");
	}
	else
	{

	templateBuilder.Append("\r\n		<form method=\"post\" name=\"postform\" id=\"postform\" action=\"\" enctype=\"multipart/form-data\" onsubmit=\"return validatereferrer();\">	\r\n		");
	}	//end if

	templateBuilder.Append("\r\n		<input id=\"poster\" name=\"poster\" type=\"hidden\" class=\"txt\" />\r\n		<input id=\"postdatetime\" name=\"postdatetime\" type=\"hidden\" class=\"txt\" />\r\n		<input id=\"blockid\" name=\"blockid\" type=\"hidden\" class=\"txt\" value=\"1\"/>\r\n\r\n		<div id=\"getPages\" style=\"display:none\">page1</div>\r\n\r\n		<div class=\"float_referrer s_clear\">\r\n			<label>区块名称:</label><input id=\"blockname\" name=\"blockname\" type=\"text\" class=\"txt\" value=\"\"/>\r\n			<cite class=\"tips\"><a id=\"getblocks\" onclick=\"getlist('page')\">按页面选择区块</a></cite>\r\n		</div>\r\n		<div id=\"getblocks_menu\" class=\"popupmenu_popup blocks\" style=\"display:none;\">\r\n			<div class=\"close_blocks\">\r\n				<a title=\"关闭\" onclick=\"close_getblocks_menu()\" class=\"float_close\" href=\"javascript:;\">关闭</a>\r\n			</div>\r\n			<div id=\"pageslayer\"></div>\r\n			<div id=\"blockslayer\" style=\"display:none;\"></div>\r\n		</div>\r\n		<div class=\"float_referrer s_clear\">\r\n			<label>区块标题:</label><input id=\"topicTitle\" name=\"topicTitle\" type=\"text\" class=\"txt\" value=\"");
	templateBuilder.Append(title.ToString());
	templateBuilder.Append("\"/>\r\n		</div>\r\n		<div class=\"float_referrer s_clear\">\r\n			<label>区块图片:</label><input id=\"selectImage\" name=\"selectImage\" type=\"text\" class=\"txt\" value=\"选择图片\"/><cite class=\"tips\"><a id=\"getimages\" onclick=\"getlist('image',");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append(")\">选择</a></cite>\r\n		</div>\r\n		<div id=\"imageList\" class=\"float_referrer s_clear\" style=\"display:none;\">\r\n			<div id=\"playlist\" class=\"playList\">\r\n				<div class=\"plBd\" id=\"plBd\">\r\n					<ul id='imagelistsider'>\r\n					</ul>\r\n				</div>\r\n				<div class=\"next\"><a id=\"previous\" href=\"javascript:;\">下一页</a></div>\r\n				<div class=\"previous\"><a id=\"next\" href=\"javascript:;\">上一页</a></div>\r\n			</div>\r\n		</div>\r\n		<div id=\"largeimage\" style=\"display:none;\"></div>\r\n		<script src=\"javascript/referrer_imagelist.js\"></");
	templateBuilder.Append("script>\r\n		<div class=\"float_referrer\"><label>区块内容:</label><textarea id=\"summary\" name=\"summary\"  class=\"txtarea\" cols=\"70\" rows=\"5\">");
	templateBuilder.Append(summary.ToString());
	templateBuilder.Append("</textarea></div>\r\n		<div id=\"moreconf\" class=\"float_referrer\">\r\n			<button name=\"add\" type=\"submit\" id=\"add\">确定</button>\r\n		</div>\r\n	</form>\r\n	</div>\r\n	</div>\r\n	");
	if (infloat==0)
	{
