<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.getip" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\">");
	templateBuilder.Append(pagetitle.ToString());
	templateBuilder.Append("</a> &raquo;<strong>查看IP</strong>\r\n	</div>\r\n</div>\r\n");
	}	//end if
	...
	templateBuilder.Append("\r\n<div class=\"float\" id=\"floatlayout_mods\">\r\n<form id=\"form2\" name=\"form2\" action=\"getip.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&pid=");
	templateBuilder.Append(postid.ToString());
	templateBuilder.Append("&action=ipban&ip=");
	templateBuilder.Append(ip.ToString());
	templateBuilder.Append("&infloat=1&\" method=\"post\" onsubmit=\"if(!confirm('你确实要禁止此IP吗?'))return false;$('form2').action='");
	templateBuilder.Append(rooturl.ToString());
	templateBuilder.Append("getip.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&pid=");
	templateBuilder.Append(postid.ToString());
	templateBuilder.Append("&action=ipban&ip=");
	templateBuilder.Append(ip.ToString());
	templateBuilder.Append("&infloat=1&';ajaxpost('form2', 'return_mods', 'return_mods','onerror');return false;\">\r\n	<h3 class=\"flb\">\r\n		<span class=\"y\"><a href=\"javascript:;\" class=\"flbc\" onclick=\"hideWindow('getip')\" title=\"关闭\">关闭</a></span>\r\n	    <em id=\"return_mods\">查看 IP</em>\r\n	</h3>\r\n	<div class=\"c cl\">\r\n	    <table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"formtable\">\r\n		    <tbody>\r\n			    <tr>\r\n				    <th width=\"60\">IP地址:</th>\r\n				    <td>");
	templateBuilder.Append(ip.ToString());
	templateBuilder.Append("</td>\r\n			    </tr>\r\n			    <tr>\r\n				    <th>所在地:</th>\r\n				    <td>");
	templateBuilder.Append(iplocation.ToString());
	templateBuilder.Append("</td>\r\n			    </tr>\r\n			    <tr>\r\n				    <th> </th>\r\n				    <td><button type=\"submit\">禁止此 IP</button> </td>\r\n			    </tr>\r\n		    </tbody>\r\n	    </table>\r\n	</form>    \r\n</div>\r\n");
	}
	else
	{
	...
	templateBuilder.Append("</td>\r\n			</tr>\r\n			<tr>\r\n				<th>所在地:</th>\r\n				<td>");
	templateBuilder.Append(iplocation.ToString());
	templateBuilder.Append("</td>\r\n			</tr>\r\n			<tr>\r\n				<th> </th>\r\n				<td>\r\n				<a href=\"###\" onClick=\"if(confirm('你确实要禁止此IP吗?')){window.location.replace('getip.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&pid=");
	templateBuilder.Append(postid.ToString());
	templateBuilder.Append("&action=ipban&ip=");
	templateBuilder.Append(ip.ToString());
	templateBuilder.Append("')}\">禁止此 IP</a>\r\n				<a href=\"###\" onclick=\"history.go(-1)\">返回上一页</a>\r\n				</td>\r\n			</tr>\r\n		</tbody>\r\n	</table>\r\n</div>\r\n</div>\r\n");
	}	//end if
