<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="Discuz.Web.myattachment" %>
...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("><a href=\"myattachment.aspx\">全部</a></li>\r\n	");
	int list__loop__id=0;
	foreach(AttachmentType list in Attachments.AttachTypeList())
	{
		list__loop__id++;
	...
	templateBuilder.Append("><a href=\"?typeid=");
	templateBuilder.Append(list.TypeId.ToString().Trim());
	templateBuilder.Append("\">");
	templateBuilder.Append(list.TypeName.ToString().Trim());
	templateBuilder.Append("</a></li>\r\n	");
	}	//end loop
	...
	templateBuilder.Append("\r\n			<tr>\r\n			<td><a href=\"");
	templateBuilder.Append(myatinfo.Filename.ToString().Trim());
	templateBuilder.Append("\" title=\"");
	templateBuilder.Append(myatinfo.Attachment.ToString().Trim());
	templateBuilder.Append("\" target=\"_blank\">");
	templateBuilder.Append(myatinfo.SimpleName.ToString().Trim());
	templateBuilder.Append("</a></td>\r\n			<td>");
	templateBuilder.Append(myatinfo.Description.ToString().Trim());
	templateBuilder.Append("</td>\r\n			<td>");
	templateBuilder.Append(myatinfo.Postdatetime.ToString().Trim());
	templateBuilder.Append("</td>\r\n			<td>");
	templateBuilder.Append(myatinfo.Downloads.ToString().Trim());
	templateBuilder.Append("</td>\r\n			</tr>\r\n		");
	}	//end loop
