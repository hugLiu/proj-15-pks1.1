...
CREATE TABLE [dnt_attachpaymentlog] (
	[id] [int] IDENTITY (1, 1) NOT NULL ,
	[uid] [int] NOT NULL ,
	[username] [nvarchar] (56) COLLATE Chinese_PRC_CI_AS NOT NULL ,
	[aid] [int] NOT NULL ,
...
CREATE TABLE [dnt_online] (
	...
	[username] [nvarchar] (56) NOT NULL CONSTRAINT [DF_dnt_online_username] DEFAULT (''),
...
CREATE TABLE [dnt_users] (
	...
	[username] [nvarchar] (56) NOT NULL CONSTRAINT [DF_dnt_users_username] DEFAULT (''),
	...
	[email] [varchar] (200) NOT NULL CONSTRAINT [DF_dnt_users_email] DEFAULT (''),
