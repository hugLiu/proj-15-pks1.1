...
namespace Discuz.Forum
{
    ...
    public class PageBase : System.Web.UI.Page
    {
        ...
        ///获得用户认证URL
        ///</summary>
        public static Func<HttpContext, OnlineUserInfo, bool> OnAuthorization { get; set; }
        ///<summary>
        ///WebAPI站点URL
        ///</summary>
        public static string WebApiSiteUrl { get; set; }
        ///<summary>
        ///WebAPI站点URL
        ///</summary>
        protected internal string webApiSiteUrl
        {
            get { return WebApiSiteUrl; }
        }
        /// <summary>
        /// 论坛配置信息
        /// </summary>
        ...
        {
            if (!OnAuthorization(this.Context, oluserinfo)) return;
            if (isguestcachepage == 1)
            {
                m_processtime = 0;
            }
