...
namespace Discuz.Forum
{
	...
	public class SoftInfo
	{
		...
		public static void LoadSoftInfo()
		{
            try
            {
                var aysncallback = new delegateLoadSoftInfo(SendPostData);
                AsyncCallback myCallBack = new AsyncCallback(CallBack);
                aysncallback.BeginInvoke(myCallBack, aysncallback);
            }
            catch(Exception e)
            {
		...
		public static void CallBack(IAsyncResult e)
		{
            try
            {
                var aysncallback = (delegateLoadSoftInfo)e.AsyncState;
