    ...
    public partial class DataProvider : IDataProvider
    {
        ...
        public void CombinationUser(string postTableName, UserInfo targetUserInfo, UserInfo srcUserInfo)
        {
            DbParameter[] parms = {
					                ...
					                DbHelper.MakeInParam("@target_username", (DbType)SqlDbType.NVarChar, 56, targetUserInfo.Username.Trim()),
        ...
        {
            var sqlText = string.Format("SELECT top 1 uid from [{0}users] where adminid=1 order by uid", BaseConfigs.GetTablePrefix);
            var uid = DbHelper.ExecuteScalar(CommandType.Text, sqlText);
            if (uid == null || uid == DBNull.Value) return -1;
            return (int)uid;
        }
        /// <summary>
        /// 获取简短用户信息
        ...
        {
            DbParameter[] parms = {
									   DbHelper.MakeInParam("@username",(DbType)SqlDbType.NVarChar, 56,userInfo.Username),
									   ...
									   DbHelper.MakeInParam("@email",(DbType)SqlDbType.VarChar,200,userInfo.Email),
