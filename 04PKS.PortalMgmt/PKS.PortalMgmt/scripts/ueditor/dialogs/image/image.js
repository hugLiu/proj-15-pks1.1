...
(function () {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,
                actionUrl = editor.getActionUrlEx(editor.getOpt('imageActionName')),
        ...
        getInsertList: function () {
            var i, data, list = [],
                ...
                serverRootUrl = editor.options.serverRootUrl;
            for (i = 0; i < this.imageList.length; i++) {
                data = this.imageList[i];
                list.push({
                    src: serverRootUrl + prefix + data.url,
                    _src: serverRootUrl + prefix + data.url,
                    title: data.title,
                    alt: data.original,
                    floatStyle: align
                });
    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                var url = editor.getActionUrlEx(editor.getOpt('imageManagerActionName')),
